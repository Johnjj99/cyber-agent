...
def _infer_severity(error_type: str) -> str:
    high = {"OPEN_PORT", "SQL_INJECTION", "MISSING_NLA", "DIRECTORY_EXPOSED", "XSS_VULNERABILITY", "PUBLIC_S3_BUCKET", "KNOWN_CVE", "FUZZING_ANOMALY", "VPN_DETECTED"}
    medium = {"MISSING_HEADER", "WEAK_SPF", "MISSING_DNS", "API_MISCONFIG", "JWT_WEAKNESS", "API_RATE_LIMIT"}
    low = {"INFO", "WARNING"}
